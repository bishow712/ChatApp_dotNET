...
function Registration() {
  ...
  return (
    <div style={{ paddingTop: "calc(100vh/15)", margin: "0 calc(100vw/8)" }}>
      <div className='rounded pt-4 pb-4' style={{ backgroundColor: "rgba(0,0,0,.7)", color: "white" }}>
        ...
        <section className='form'>
          <form action="" onSubmit={onSubmit}>
            ...
            <div className="form-group">
              <button type="submit" className='btn btn-outline-secondary btn-block button' style={{ border: "1px solid grey" }}>Register</button>
            </div>
          </form>
        </section>
